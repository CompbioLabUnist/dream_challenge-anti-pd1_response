...
if __name__ == "__main__":
    ...
    final_data = pandas.concat([object_data, tsne_data], axis="columns", join="inner", verify_integrity=True)
    print(final_data)
    ...
    for feature in sorted(object_data.columns):
        ...
        seaborn.scatterplot(data=final_data, x="TSNE1", y="TSNE2", hue=feature, style=feature, ax=ax, legend="full")
